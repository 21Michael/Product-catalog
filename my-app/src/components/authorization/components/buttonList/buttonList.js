...
const ButtonList = (props) => {
    ...
    return <div className ={classes.wrapper}> 
		    	<span className = {createClass()}>
					Authorization message: { props.authorizationMessage }
				</span>
...
function mapStateToProps(state) {
    return {
        ...
        authorizationMessage: state.authorization.currentUser.message,
        answerType: state.authorization.currentUser.answerType
    }
}
